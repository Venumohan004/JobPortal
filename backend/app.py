...
# IMPORTANT:
# This is the ACTIVE admin routes file.
...
def config_test():
    ...
    return {
        ...
        "MAIL_SERVER": app.config.get(
            "MAIL_SERVER"
        ),

        "MAIL_PORT": app.config.get(
            "MAIL_PORT"
        ),
        ...
        "MAIL_DEFAULT_SENDER": app.config.get(
            "MAIL_DEFAULT_SENDER"
        ),

        "MAIL_USE_TLS": app.config.get(
            "MAIL_USE_TLS"
        )
    }
...
def test_mail():
    ...
    try:
        ...
        msg = Message(
            ...
            recipients=[
                "pvenumohan831@gmail.com"
            ],

            body=(
                "This is a test email from "
                "Flask-Mail on Render."
            )
        )
